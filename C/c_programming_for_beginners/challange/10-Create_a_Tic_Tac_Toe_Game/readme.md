# 10-Create_a_Tic_Tac_Toe_Game

## Requirements

Write a program that plays tic-tac-toe. Game is played on a 3x3 grid the game is played by two players, who take turns.

You should create an array to represent the board. It can be of type char and consist of 10 elements (do not use zero). Each element represents a coordinate on the board that the user can select.
